...
public class BomItem extends Entity{
    ...
    public void setBomExploded() {
        ...
        if (SizeBom == 1) {
            ...
            if(col+2 <= WIDTH) {
                ...
                else if(map[row][col+2] != ' ' && map[row][col+1] == ' ') {
                    bomb[1].setEntity(col+1,row,Sprite.explosion_horizontal_right_last.getFxImage());
                    checkbomb[1] = true;
                }
            }
            ...
            if(row+2 <= HEIGHT) {
                if(map[row+2][col] == ' ' && map[row+1][col] == ' ') {
                    bomb[8].setEntity(col,row+1,Sprite.explosion_vertical_down_last.getFxImage());
                    checkbomb[8] = true;
                ...
                else if(map[row+2][col] != ' ' && map[row+1][col] == ' ')
                {
                    bomb[7].setEntity(col,row+1,Sprite.explosion_vertical_down_last.getFxImage());
                    checkbomb[7] = true;
                    stillObjects.add(bomb[7]);
            ...
            if(col-2 >= 0) {
                ...
                else if (map[row][col-2] != ' ' && map[row-1][col] == ' ') {
                    bomb[3].setEntity(col-1,row,Sprite.explosion_horizontal_left_last.getFxImage());
                    checkbomb[3] = true;
                    stillObjects.add(bomb[3]);
                }
                ...
                if (map[col-1][row] == ' ') {
                    bomb[3].setEntity(row, 0,Sprite.explosion_horizontal_left_last.getFxImage());
                    checkbomb[3] = true;
                    stillObjects.add(bomb[3]);
                }
            }
        ...
        if (SizeBom == 1) {
            ...
            if(col+2 <= WIDTH) {
                if(map[row][col+2] == ' ' && map[row][col+1] == ' ') {
                    ...
                    bomb[1].setImg(Sprite.explosion_horizontal_right_last.getFxImage());
                }
            }
            else if(col + 1 == WIDTH) {
                if(map[row][col+1] == ' ') {
    ...
    public void setPos(int a, int b){
        ...
        bomb[0].setEntity(x, y, Sprite.bomb.getFxImage());
    ...
    public int checkRight(){
        ...
        if(SizeBom == 2 && ColX + 2 < WIDTH && map[RowY][ColX+2] == '*' ) {
            return 2;
        }
        return 0;
    }
